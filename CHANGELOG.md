...
- Typed mappings and visual editing for layers 2 and 3.
- Keyboard keys, Omarchy shortcuts, gestures, autosave, Clear, and Revert.
- USB/Bluetooth transport with paced writes, backups, and readback validation.
