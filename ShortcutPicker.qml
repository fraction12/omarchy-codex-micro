// Based on Omarchy Ui/SearchableDropdown.qml; local trigger-toggle fix.
import QtQuick
...
Item {
  ...
  Column {
    ...
    BorderSurface {
      ...
      QQC.Popup {
        id: popup
        // Keep a click on the trigger for its own toggle handler. Closing on
        // press-outside first would make that handler reopen the popup.
        ...
        contentItem: Column {
          ...
          Item {
            id: searchHeader
            width: parent.width
            height: searchField.implicitHeight + 2 * Style.spacing.md
            ...
            ListView {
              ...
              delegate: Rectangle {
                ...
                MouseArea {
                  ...
                  onClicked: { resultList.currentIndex = parent.index; resultList.selectCurrent() }
                }
              }
            }
          }
